...
function PreviousMonthsReportCard({data}: PreviousMonthsReportCardProps) {
    ...
    return (<div className="bg-white border border-gray-200 rounded-xl shadow-sm p-5 transition-shadow flex flex-col gap-6">
        <div className="py-2">
            ...
            {data && data.length > 0 ?
            data.map(item => (<div className="flex items-center justify-between w-full bg-gray-100 rounded p-4">
                <div>
                    <h3 className="text-md text-gray-800 font-bold">Nome do mes</h3>
